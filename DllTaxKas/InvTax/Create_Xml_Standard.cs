...
namespace KSAEinvoice
{
    ...
    public class Create_Xml_Standard : TaxShared
    {
...
<cac:Signature>
      ...
      <cbc:SignatureMethod>urn:oasis:names:specification:ubl:dsig:enveloped:xades</cbc:SignatureMethod>
                    ...
                    <cac:AccountingCustomerParty>
                      <cac:Party>
                             <cac:PartyIdentification>
                                <cbc:ID schemeID=""SET_schemeIDCustomer_Name"">Cust_schemeID</cbc:ID>
                             </cac:PartyIdentification>
                             <cac:PostalAddress>
                                <cbc:StreetName>Cust_StreetName</cbc:StreetName>
                                <cbc:BuildingNumber>Cust_BuildingNumber</cbc:BuildingNumber>
                                <cbc:PlotIdentification>Cust_PlotIdentification</cbc:PlotIdentification>
                                <cbc:CitySubdivisionName>Cust_CitySubdivisionName</cbc:CitySubdivisionName>
                                <cbc:CityName>Cust_CityName</cbc:CityName>
                                <cbc:PostalZone>Cust_PostalZone</cbc:PostalZone>    
                                <cbc:CountrySubentity>Cust_CountrySubentity</cbc:CountrySubentity>
                                <cac:Country>
        ...
        public string _Creare_Xml_Standard(Invoice_xml props)
        {
